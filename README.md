...
1. **Does autoftp delete my files?** File deletions events in the directory path are _not_ mirrored on the FTP server.  With the `--updelete=|-k` option, matching files _which have been successfully uploaded_ are deleted. 
